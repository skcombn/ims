...
export const TableHeader = () => (
  <View style={tablestyles.container}>
    <Text style={tablestyles.custno}>Supp No</Text>
    <Text style={tablestyles.cust}>Supplier</Text>
...
export const TableRow = ({ items, totals }) => {
  const rows = items.map((item, index) => (
    <View style={tablerowstyles.row} key={index}>
      ...
      <Text style={tablerowstyles.cust}>{item.s_supp}</Text>
      <Text style={tablerowstyles.tel}>
        {item.s_tel1} /{item.s_tel2}
      </Text>
      <Text style={tablerowstyles.fax}>{item.s_fax}</Text>
      <Text style={tablerowstyles.email}>{item.s_email}</Text>
      <Text style={tablerowstyles.contact}>{item.s_contact}</Text>
      <Text style={tablerowstyles.area}>{item.s_area}</Text>
    </View>
  ));
  return <>{rows}</>;
};
...
const SuppliersListingRptPrint = () => {
...
export default SuppliersListingRptPrint;
